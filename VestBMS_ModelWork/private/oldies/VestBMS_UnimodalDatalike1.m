% CUEBMS_UNIMODALDATALIKE1 Calculate log likelihood of one unimodal trial
...
%
function varargout = CueBMS_UnimodalDatalike1(X,model,theta,priorinfo,MAXRNG,XGRID,SSCALE,sumover,randomize)
...
[hx,hw] = hermquad(ceil(sqrt(XGRID))*8+1);
hx = hx'*sqrt(2);
hw = hw'/sqrt(pi);
